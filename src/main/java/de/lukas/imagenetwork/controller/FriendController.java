...
//    List<Friend> all(@AuthenticationPrincipal User user) {
...
//    @GetMapping("/friends")
//    List<User> ownFriends(@AuthenticationPrincipal User user) {
...
//    List<User> userFriends(@PathVariable Long id, @AuthenticationPrincipal User user) {
//        if(id == null)
//            id = user.getId();
